...
****Создана функция для фильтрации списка банковских операций
по по наличию строки поиска в описании(пусть - src/filter_bank_transactions_by_word.py)****
```
process_bank_search
```

****Функция счита количество операций (путь - src/filter_bank_transactions_by_word.py))****
```
process_bank_operations_advanced
```

****Весь функционал проекта реализован в main.py****
